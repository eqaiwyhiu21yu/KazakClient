...
import me.aidan.sydney.utils.system.ThreadExecutor;
...
@RegisterModule(name = "Blocker", description = "Places blocks to stop enemies from placing crystals.", category = Module.Category.COMBAT)
