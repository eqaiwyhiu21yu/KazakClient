...
import me.aidan.sydney.mixins.accessors.ClientPlayerInteractionManagerAccessor;
...
public class InventoryUtils implements IMinecraft {
    ...
    public static void switchSlot(String mode, int slot, int previousSlot) {
        ...
        if (slot == -1 || previousSlot == -1 || slot == Sydney.POSITION_MANAGER.getServerSlot()) return;
